...
let seriesOrdenadas = null;

document.getElementById('filtroSer').addEventListener('click', function() {
    if (seriesOrdenadas === null) {
        seriesOrdenadas = ordenarPorAño(series);
        mostrarSeries(seriesOrdenadas);
        this.classList.add('activado');
        this.innerText = "filtrar por orden cronológico";
    } else {
        mostrarSeries(series);
        seriesOrdenadas = null;
        this.classList.remove('activado');
        this.innerText = "Filtrar por año";
    }
});
